...
export const api = {
  ...
  renameInstance: (id: string, name: string) =>
    request<Instance>(`/api/instances/${id}`, {
      method: 'PATCH',
      body: JSON.stringify({ name }),
    }),
  ...
  createRun: (id: string, inputJson: Record<string, unknown>, runName: string) =>
    request<Run>(`/api/instances/${id}/runs`, {
      method: 'POST',
      body: JSON.stringify({ input_json: inputJson, run_name: runName }),
    }),
  ...
  renameRun: (instanceId: string, runId: string, name: string) =>
    request<Run>(`/api/instances/${instanceId}/runs/${runId}`, {
      method: 'PATCH',
      body: JSON.stringify({ name }),
    }),
