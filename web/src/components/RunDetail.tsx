...
export function RunDetail({ run, result, onBack, onCancel, onDelete, onNewRun, onRename }: RunDetailProps) {
  ...
  return <Container size="xl" py="xl">
    ...
    <ContainerTable containers={containers} /><Suspense fallback={<Paper withBorder mt="lg" p="md"><Group justify="center"><LoaderCircle size={18} /><Text size="sm" c="dimmed">正在加载三维视图</Text></Group></Paper>}><Viewer3D containers={containers} pallets={pallets} /></Suspense>
