    ...
    return <Container size="xl" py="xl">
        ...
        {result && <>
            <SimpleGrid cols={{ base: 1, sm: 2, lg: 4 }} mb="lg">
                ...
                <Metric label="已装 / 未装箱" value={`${result.summary.packed_box_count} / ${result.summary.unpacked_box_count}`} icon={<BoxIcon size={17} />} />
                <Metric label="结果状态" value={result.status} icon={<FileJson size={17} />} />
            </SimpleGrid>
            <Suspense fallback={<Paper withBorder p="md"><Group justify="center"><LoaderCircle size={18} /><Text size="sm" c="dimmed">正在加载三维视图</Text></Group></Paper>}><Viewer3D containers={containers} pallets={pallets} /></Suspense>
