...
- **障碍物角点**：初始化时把每个障碍物的 8 角点（4 顶角可上到顶面、4 底角可贴侧）加入极点集，保证障碍物周边可达。零厚膜（某维为 0）角点塌缩为 4 个，仍保证膜周边可达。
...
- **障碍物角点**：初始化时把每个障碍物的 8 角点（4 顶角可上到顶面、4 底角可贴侧）加入极点集（同 GEP），保证障碍物周边可达。零厚膜角点塌缩为 4 个，仍保证膜周边可达。
